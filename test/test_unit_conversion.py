...
from main.unit_conversion import get_user_selected_unit_and_convert, convert_nm_to_meters, convert_nm_to_feet, \
    convert_nm_to_miles, convert_nm_to_km


class TestUnitConversion(TestCase):
    def test_get_user_selected_unit_and_convert(self):
        input_value = 1
        unit_to_convert_to = 'Km'
        self.assertEqual(1.852, get_user_selected_unit_and_convert(input_value, unit_to_convert_to))
