...
def run_kml_process_only(input_file_one, input_file_two, output_folder, first_file_type, second_file_type):
...
def run_google_api_process_only(input_file_one, input_file_two, output_folder, api_key, samples, first_file_type,
                                second_file_type):
    ...
    for i in first_location_list:
        ...
        for x in second_location_list:
            ...
            time.sleep(2)
    return "Graphing process complete."


def run_kml_and_graphing_process(input_file_one, input_file_two, output_folder, api_key, samples, first_file_type,
                                 second_file_type):
    # This will have options in future for different units of measurement
    earth_radius = 3440.065  # in nm
