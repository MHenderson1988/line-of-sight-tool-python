...
def validate_longitude_latitude(a_long, a_lat) -> Union[TypeError, ValueError, bool]:
...
def validate_google_sample_number(a_number) -> Union[TypeError, ValueError, bool]:
